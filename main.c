...
int main()
{
    ...
    enemy->width =180;
    enemy->height = 130;
    enemy->texture = loadTexture(app, "enemy.png"   );

    enemy2->pos_x = 174;
    enemy2->pos_y = 60;
    enemy2->width =180;
    enemy2->height = 130;
    enemy2->texture = loadTexture(app, "enemy.png"   );
    ...
    enemy3->width =180;
    enemy3->height = 130;
    enemy3->texture = loadTexture(app, "enemy.png"   );
    ...
    enemy4->width =180;
    enemy4->height = 130;
    enemy4->texture = loadTexture(app, "enemy.png"   );
    ...
    enemy5->width =180;
    enemy5->height = 130;
    enemy5->texture = loadTexture(app, "enemy.png"   );
